                ...
                <div class="card-body bg-secondary">
                  <div class="row">
                    <div class="col-md-6 col-sm-6 col-12">
                      <div class="info-box bg-secondary outline-dark">
                        <span class="info-box-icon bg-warning"><i class="fas fa-download"></i></span>

                        <div class="info-box-content text-dark bg-secondary">
                    ...
                    <div class="col-md-6 col-sm-6 col-12">
                      <div class="info-box bg-secondary">
                        ...
                        <div class="info-box-content text-dark bg-secondary">
                          <span class="info-box-text">Complaint Finished</span>
                    ...
                    <div class="col-md-6 col-sm-6 col-12">
                      <div class="info-box bg-secondary">
                        ...
                        <div class="info-box-content text-dark bg-secondary">
                          ...
                          <span class="info-box-number"><?php echo $jml_masyarakat; ?> </span>
                        </div>
                        <!-- /.info-box-content -->
                      </div>
                      <!-- /.info-box -->
