                ...
                <div class="card-body">
                  <table  id="example" class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      while($d = mysqli_fetch_array($petugas)){
                        ?>
                        <tr>
                          <td><?php echo $no++; ?></td>
                          ...
                          <script>
                                  function hapus() {
                                    if (confirm("are you sure want to delete Report?, Data will be lost forever!")) {
                                      location.href = 'hapus_petugas.php?id_petugas=<?php echo $d['id_petugas']; ?>';
                                    }
                                  }
                                  </script>
                          </td>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content bg-dark">
                        ...
                        <div class="modal-body bg-dark">
                          <form method="post" action="simpan_daftarpetugas.php" enctype="multipart/form-data">
                            <div class="card-body">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" name="telp" class="form-control" placeholder="Nomer Telepon">
                              </div>
