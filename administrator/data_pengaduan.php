                    ...
                    <tbody>
                      ...
                      while($d = mysqli_fetch_array($catatan)){
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="" class="btn btn-info btn-sm"  data-toggle="modal" data-target="#modal-tanggapan<?php echo $d['id_pengaduan']; ?>"><i class="fas fa-edit"></i> Response</a>
                        ...
                        <div class="modal fade " id="modal-tanggapan<?php echo $d['id_pengaduan']; ?>">
                          <div class="modal-dialog ">
                            <div class="modal-content bg-dark">
                              <div class="modal-header">
                                <h4 class="modal-title">Verivication and Write Response</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
